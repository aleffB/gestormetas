...
if(!isset($_SESSION['nomeuser_adm']) && !isset($_SESSION['login_adm'])){
  ...
  exit;
      ...
      //verifica se o usuário é ADM ou DEPENDENTE e executará as consultas abaixo
         if($valid==1){
 $sql_code4 = "SELECT * FROM orgaos";
        ...
        //caso clique em confirmar executará o código abaixo
        if(isset($_POST['confirmar'])){
      //as variáveis abaixo guardarão os valores dos compos inseridos
      $codorg = $_POST['descorgao'];
      $iddep = $_POST['descinddep'];

        // haverá uma consulta utilizando a variável $codorg como restrição
       ...
       $linhas = $show->fetch_assoc();
        // salvando o código do orgão na variável $resgateagain
       $resgateagain = $linhas['cod_orgao'];

       ////
        // haverá uma consulta utilizando a variável $iddep como restrição
       ...
       // salvando o id do indicador departamental na variável $resgate
       $resgate = $linha['id_inddep'];
//foreach para pegar os valores
    foreach ($_POST as $chave=>$valor) 
    $_SESSION[$chave] = $mysqli->real_escape_string($valor);

                  //validação do código do orgão e do id
            if( $resgateagain == $codorg  && $resgate == $iddep ){
              $sql_code= "INSERT INTO meta(
            cod_org, id_inddep, anob, desc_meta, responsavel)
...
<form action="" method="POST">
 ...
 <option <?php echo (isset($_POST['anob']) && $linhatabela2['anob'] == $_POST['anob']) ? "selected" : ''; ?>  value="<?php  echo $linhatabela2['anob']; ?>"> <?php echo $linhatabela2['anob'];?></option>
  ...
  <input name="descmeta" required value="" type="text" class="form form-control" style="text-align: center;">
  <p class=espaco></p>
