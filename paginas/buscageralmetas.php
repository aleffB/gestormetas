...
if($valid==1){
 ...
 $sql_code4 = "SELECT * FROM orgaos";
        ...
        $sql_code6 = "SELECT id.desc_inddep, id.melhor_traj, id.acumulativo, id.und_med, m.desc_meta, io.meta_fx1, io.meta_fx2
					FROM indicadororgao AS io 
					INNER JOIN indicadordepartamental AS id  ON io.id_inddep = id.id_inddep
          INNER JOIN meta as m ON m.id_inddep = id.id_inddep
...
<!-- criação de uma tabela -->
 <tr class= titulo>
   ...
   <td>META</td> 
   <td>UNIDADE</td> 
   <td>TIPO DE INDICADOR(N OU I)</td> 
...
<!-- criação das linhas da tabela -->
 	 <td id="descindep"><?php  echo $linhatabela6['desc_meta'];?></td> 
   <td id="melhortraj"><?php echo $linhatabela6['desc_inddep'];?></td>
...
?>
 <tr class= titulo>
   <td id="form"><?php echo $linhatabela6['desc_meta'];?></td>
