<?php
  $sql_code = "SELECT * FROM indicadores";
  ...
  $acum[2] = "Sim, acumulado na fórmula";
...
<center>
<div >
<h1>Indicador Empresarial</h1>

<p class=espaco></p>
<table border=1 cellpadding=10 class="table">
 <tr class= titulo>
   <td style='font-weight:bold';>Ano base</td>
   <td style='font-weight:bold';>Descrição Indicador Empresarial</td> 
   <td style='font-weight:bold';>Melhor Trajetória</td> 
   <td style='font-weight:bold';>Acumulativo</td> 
   <td style='font-weight:bold';>Unidade de Medida</td> 
   <td style='font-weight:bold';>Observação</td> 
   <td style='font-weight:bold';>Meta fx1</td> 
   <td style='font-weight:bold';>Meta fx2</td> 
 ...
 ?>
 <tr>
  <td><?php echo $linha['ano_base'];?></td> 
  <td><?php echo $linha['desc_indicador'];?></td>
  <td><?php echo $mtj[$linha['melhor_traj']];?></td>  
  <td><?php echo $acum[$linha['acumulativo']];?></td>  
  <td><?php echo $und[$linha['und_medida']];?></td> 
  <td><?php echo $linha['obs'];?></td> 
  <td><?php echo $linha['meta_fx1'];?></td>
  <td><?php echo $linha['meta_fx2'];?></td>  
