...
if(isset($_POST['confirmar'])){
        ...
        // variável $senha, receberá o valor do campo
        $senha = $_POST["senha"];
   ...
   foreach ($_POST as $chave=>$valor) 
    $_SESSION[$chave] = $mysqli->real_escape_string($valor);
        ...
        $sql_code= "INSERT INTO senha_adm(
            senha)
        ...
        $correct = "Senha cadastrada com sucesso.";
...
<h1>Cadastro de Senhas para ADM</h1>
<p class=espaco></p>
...
<form action="" method="POST">
  ...
  <input name="senha" required value="" class="form form-control" style="text-align: center;">
  <p class=espaco></p>
