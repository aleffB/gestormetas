...
<form action="" method="POST">
  ...
  <select name="diretoria" required class="form form-control">
  <option value="">Selecione</option>
  <?php 
  do{
  ?> <!-- usando o array de retorno das consultas no banco para inserir neste html select -->
  <option <?php echo (isset($_POST['diretoria']) && $linhatabela['id_diretoria'] == $_POST['diretoria']) ? "selected" : ''; ?>  value="<?php  echo $linhatabela['id_diretoria']; ?>"> <?php echo $linhatabela['desc_diretoria'];?></option>
     <!-- onde enquanto tiver dados no array, ele repetirá, até não haver mais nenhum dado a ser exibindo, criando uma lista no select com os dados desejados do banco -->
  <?php } while($linhatabela = $sql_query->fetch_assoc());  ?>
  </select>
  <p class=espaco></p>

    <label for="codorgao"> Código do Orgão</label>
  <input name="codorgao" required value="" type="numeric" class="form form-control" style="text-align: center;">
  <p class=espaco></p>

  <label for="desc"> Descrição do Orgão</label>
  <input name="desc" required value="" class="form form-control" style="text-align: center;">
  <p class=espaco></p>

  <label for="dataref"> Data de Referência</label>
  <input name="dataref" required value="" type="date" class="form form-control" style="text-align: center;">
  <p class=espaco></p>

  <label for="sigla"> Sigla</label>
  <input name="sigla" required value="" class="form form-control" style="text-align: center;">
  <p class=espaco></p>

    

  <label for="gerente"> Gerente</label>
  <input name="gerente" required value="" class="form form-control" style="text-align: center;">
  <p class=espaco></p>
