<?php
  $sql_code = "SELECT * FROM indicadordepartamental";
...
<center>
<div >
<h1>Indicador Departamental</h1>

<p class=espaco></p>
<table border=1 cellpadding=10 class="table">
 <tr class= titulo>
   <td style='font-weight:bold';>Ano base</td>
   <td style='font-weight:bold';>Descrição Indicador Departamental</td> 
   ...
   <td style='font-weight:bold';>Fórmula</td> 
